...
def extract_for_file(file_path, file_format=None):
    ...
    map_cls = {"disjoint": "disjointWith", "equivalent": "equivalentClass", "restriction": "propertyRestrictions"}
...
def main():
    ...
    for fname in os.listdir(dir_path):
        if fname.endswith(".owl") or fname.endswith(".ttl") or fname.endswith(".rdf"):
